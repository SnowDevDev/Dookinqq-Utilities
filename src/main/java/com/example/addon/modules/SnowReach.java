...
public class SnowReach extends Module {
    public static SnowReach INSTANCE;
    ...
    public SnowReach() {
        super(AddonTemplate.CATEGORY, "Snow Reach", "Gives you super long arms. Lets you Mace Smash at long range in Paper servers.");
        INSTANCE = this;
    }
    @Override
    public void onActivate() {
        if (mode.get() == Mode.Paper) maxDistance = Distance.get();
