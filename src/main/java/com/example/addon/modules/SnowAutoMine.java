...
public class SnowAutoMine extends Module {
    ...
    // ==================== CONSTRUCTOR ====================
    public SnowAutoMine() {
        super(AddonTemplate.CATEGORY, "Dookinqq Auto Mine",
    ...
    public void onActivate() {
        ...
        if (mc.player != null) {
            lastSelectedSlot = com.example.addon.utils.Compat.getSelectedSlot(mc.player.getInventory());
        }
    }
    ...
    public void onDeactivate() {
        ...
        if (lastSelectedSlot != -1 && mc.player != null &&
            com.example.addon.utils.Compat.getSelectedSlot(mc.player.getInventory()) != lastSelectedSlot) {
