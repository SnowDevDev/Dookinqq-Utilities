...
public class SnowSwing extends Module {
    public SnowSwing() {
        super(AddonTemplate.CATEGORY, "Snow Swing", "Modifies swing rendering.");
    }
