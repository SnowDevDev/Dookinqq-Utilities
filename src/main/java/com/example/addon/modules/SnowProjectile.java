...
public class SnowProjectile extends Module {
    public static SnowProjectile INSTANCE;
    ...
    public SnowProjectile() {
        super(AddonTemplate.CATEGORY, "Snow Projectile", "Teleports backward on item use (pearl/potion) to safe furthest position.");
        INSTANCE = this;
    }
