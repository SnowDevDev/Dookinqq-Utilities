...
public class SnowSuperCrash extends Module {
    ...
    public SnowSuperCrash() {
        super(AddonTemplate.CATEGORY, "Dookinqq Super Crash", "CRYSTAL || A newly developed crash method.");
    }
