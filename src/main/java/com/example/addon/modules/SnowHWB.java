...
import com.example.addon.utils.HIGUtils;
...
public class SnowHWB extends Module {
    public enum Floor {
        Replace,
        PlaceMissing
    }
    ...
    private enum State {
        ...
        Forward {
            ...
            private void checkTasks(SnowHWB b) {
            ...
            private boolean needsToMine(SnowHWB b, SnowHWB.MBPIterator it, boolean mineBlocksToPlace) {
                for (MBlockPos pos : it) {
            ...
            private boolean needsToPlace(SnowHWB b, SnowHWB.MBPIterator it, boolean liquids) {
                for (MBlockPos pos : it) {
            ...
            private boolean isCrystalTrap(SnowHWB b) {
        ...
        ReLevel {
            ...
            private int findAcceptablePlacementBlock(SnowHWB b) {
        ...
        Restock {
            ...
            private boolean restockItems(SnowHWB b, Inventory inv) {
                if (b.restockTask.materials) {
                    // take raw material
            ...
            private void setShulkerPredicate(SnowHWB b) {
            ...
            private void handleContainerBlock(SnowHWB b, BlockPos bp) {
                if (breakContainer) {
        ...
        DefuseCrystalTraps {
            ...
            private float aim(SnowHWB b, Entity target) {
        ...
        protected abstract void tick(SnowHWB b);

        protected void mine(SnowHWB b, SnowHWB.MBPIterator it, boolean mineBlocksToPlace, SnowHWB.State nextState, SnowHWB.State lastState) {
        ...
        private void doubleMine(SnowHWB b, ArrayDeque<BlockPos> blocks) {
            if (b.breakTimer > 0) return;
        ...
        protected void place(SnowHWB b, MBPIterator it, int slot, State nextState) {
        ...
        protected int findHotbarSlot(SnowHWB b, boolean replaceTools) {
            int thrashSlot = -1;
        ...
        protected int findAndMoveToHotbar(SnowHWB b, Predicate<ItemStack> predicate) {
            // Check hotbar
        ...
        protected int findBlocksToPlace(SnowHWB b) {
        ...
        protected int findBlocksToPlacePrioritizeTrash(SnowHWB b) {
            int slot = findAndMoveToHotbar(b, itemStack -> {
                if (!(itemStack.getItem() instanceof BlockItem)) return false;
                return b.trashItems.get().contains(itemStack.getItem());
            });
    ...
    private interface MBPIterator extends Iterator<MBlockPos>, Iterable<MBlockPos> {
        ...
        default int placementsPerTick(SnowHWB b) {
    ...
    private class StraightBlockPosProvider implements IBlockPosProvider {
        ...
        public MBPIterator getBlockade(boolean mine, BlockadeType blockadeType) {
            return new MBPIterator() {
                ...
                @Override
                public int placementsPerTick(SnowHWB b) {
                    return 1;
                }
            };
        }
